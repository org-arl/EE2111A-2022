...
# ╔═╡ 38a6bd6a-f465-48c7-8957-cd542dcdbe92
md"## Sinusoidal Waveforms"

# ╔═╡ 68fe06b9-9107-4670-ae3b-078ad7778cef
md"""
$y = A\sin(\omega t + \phi)$
$\omega = 2\pi f$
"""
...
$(@bind A Slider(0.0:0.1:10.0; default=5.0, show_value=true))

f (Hz)

$(@bind f Slider(10:100; default=50, show_value=true))
